                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="" src="{{url('/img/Rifaweb2.png')}}" width="438" style="max-width:238px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																			...
																			<table class="border" width="100%" cellspacing="0" cellpadding="6">
																					<tbody>
																							<tr>
																									...
																									<td style="width: 30%;"><span>Rifa</span></td>
																									<td style="width: 30%;"><span>Boletos</span></td>
																									<td style="width: 10%;"><span>Precio unitario</span></td>
																									<td style="width: 20%;"><span>Subtotal</span></td>
																							</tr>
																							<?php $grantotal=0; ?>
																							@foreach ($orden->items as $item)
																								<?php 
																											$grantotal=$grantotal+intval($item->precio);
																								?>
																								<?php $boletos=explode(',',str_replace("t", "", $item->boletos)); $contador=0;?>

																							<tr class="text">
																									<td style="width: 10%;">{{$item->cantidad}}</td>
																									<td style="width: 30%;">{{$item->producto}}</td>
																									<td style="width: 30%;"><span># @foreach($boletos as $boleto) @if($contador==0){{$boleto}} <?php $contador++;?> @else , {{$boleto}} @endif @endforeach</span></td>
																									<td style="width: 10%;">${{$item->precio}}</td>
																									<td style="width: 20%;">${{$item->precio*$item->cantidad}}</td>
																							</tr>
																							@endforeach
