...
Route::group(['middleware' => 'admin'], function(){
	...
	Route::get('/admin', function () {
		...
		$ventas=App\Operacion::whereBetween('fecha', array($from, $to))->where('tipo', 'like', '%Compra%')->sum('pesos');
		$rt=App\Operacion::whereBetween('fecha', array($from, $to))->where('tipo', 'like', '%Compra%')->sum('rt');
